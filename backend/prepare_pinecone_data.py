...
OUTPUT_FILE = os.path.join(os.path.dirname(__file__), 'pinecone_qa_data.json')
...
QUESTION_MAP = {
    ...
    'q27_max_min_planet_temp': {
        'question': 'What’s the max and min equilibrium temperature recorded in the dataset?',
